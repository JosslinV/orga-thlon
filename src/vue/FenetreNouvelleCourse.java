...
public class FenetreNouvelleCourse extends JFrame {
	...
	public FenetreNouvelleCourse() throws Exception {
		...
		this.setTitle( id_Course +" : " + "cr�ation d'une nouvelle fiche COURSE");
		...
		pCentre.add(sp);
		sp.setPreferredSize(new Dimension(650,370)); // �dition de la dimension du JSplitPane
		sp.setOneTouchExpandable(true); //permet de faire glisser le s�parateur avec la souris
		sp.setDividerLocation(270); //fixe la position du s�prarateur
		sp.setBorder(new EmptyBorder(10,20,10,20));

		//� Gauche du s�parateur
		...
		Object [][] donneesParcours = {
				...
				{"Course � pied",distanceCourseAPied,villeCourseAPied,cpCourseAPied},
	...
	public void setActifComposants(boolean actif){
		...
		//this.spNbParticipants.setEnabled(actif); //lever un avertissement en cas d'�cition du spinner en mode consultation
