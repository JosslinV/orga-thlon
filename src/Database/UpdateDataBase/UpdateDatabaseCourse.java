...
public class UpdateDatabaseCourse {
	...
	public void updateDatabase(Course donnees) {
		...
		try {
			...
			preparedStatement.setInt(14, donnees.getCP_ville_nat());
			preparedStatement.setInt(15, donnees.getCP_ville_cyc());
			preparedStatement.setInt(16, donnees.getCP_ville_cou());
			preparedStatement.setInt(17, donnees.getCP_ville_arr());
